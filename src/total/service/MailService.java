...
public class MailService {
	...
	public boolean sendWelcomeMail(String target) {
		...
		try {
			...
			// 보내는 사람 - google 서버갇은 경우는 이 설정을 무시함.
			...
			content +=  "<a href=\"http:\\192.168.10.84\">사이트 둘러보기</a>";
			message.setContent(content,"test/plain;charset=utf-8");
				// content 설정을 text/html;charset=uft-8 이라고 보내면..HTML로 보낼수도 있다. 
